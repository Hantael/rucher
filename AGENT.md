...
Ce projet a été généré et structuré avec l'assistance de **Gemini** (Antigravity AI). Ce fichier regroupe toutes les informations utiles pour maintenir, modifier et héberger le site web statique du rucher.
